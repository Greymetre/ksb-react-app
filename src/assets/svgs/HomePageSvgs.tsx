...
function AddCustomerIcon(props: any) {
  return (
    <Svg
      ...
      {...props}
    >
      <Circle cx={34.1694} cy={16.5771} r={16.5771} fill="#11325B" />
      <Path
        ...
        fill="#11325B"
      />
      <Circle cx={58.0201} cy={61.0655} r={9.9801} fill="#8A5A08" />
    </Svg>
  )
}
  ...
  return (
    ...
    >
      <Path
        ...
        fill="#8A5A08"
      />
      <Circle cx={15.3449} cy={8.68571} r={8.68571} fill="#11325B" />
      <Circle cx={45.7448} cy={8.68571} r={8.68571} fill="#11325B" />
      <Path
...
function LoyaltyIcon(props: any) {
  return (
    <Svg
      ...
      {...props}
    >
      <Path d="M12.5 2h11l9 17h-11l-9-17z" fill="#8A5A08" />
      <Path d="M35.5 2h11l-9 17h-11l9-17z" fill="#11325B" />
      <Circle cx={29.5} cy={41} r={22} fill="#8A5A08" />
      <Circle cx={29.5} cy={41} r={15.5} fill="#11325B" />
      <Path
  ...
  return (
    ...
    >
      <Path
        ...
        fill={props?.color ? props?.color : "#173C68"}
      />
    </Svg>
  )
}
...
function PlusIcon(props: any) {
  return (
    <Svg
      ...
      {...props}
    >
      <Circle cx={12} cy={12} r={12} fill="#173C68" />
      <Path
...
function AddCartMiunsIcon(props: any) {
  return (
    ...
    >
      ...
      <Path d="M7.537 12.888v-1.776h8.925v1.776H7.537z" fill="#173C68" />
    </Svg>
  )
}
